/* ============================================================================
   🎧 CFC-VOICE READER PRO — V20 REAL POLLING (ULTRA FINAL)
   Chrome PC + Chrome Android (compatibilidad total)
   - Polling seguro hasta obtener voces reales (masculinas incluidas)
   - Botón premium fijo abajo izquierda
   - Panel compacto 1/4 pantalla
   - Resume exacto palabra por palabra
   - Velocidad dinámica REAL mientras lee
   - Highlight sin modificar HTML
   - Diseño negro/dorado premium CFC
   ============================================================================ */
...
/* ============================================================================
   2) POLLING DE VOCES — ELIMINA 100% EL PROBLEMA “NO LEE / NO HAY VOCES”
============================================================================ */
function loadVoicesPolling(maxAttempts = 20) {
    return new Promise(resolve => {
        ...
        const timer = setInterval(() => {
            ...
            if (attempts >= maxAttempts) {
                clearInterval(timer);
                alert("⚠️ El narrador no pudo cargar voces. Recargá la página.");
                resolve(false);
            }
        }, 200);
    });
...
/* ============================================================================
   5) MOTOR PRINCIPAL (Resume exacto + velocidad dinámica)
============================================================================ */
function speakFrom(i) {
    if (i >= words.length) return stopReading();

    index = i;

    utter = new SpeechSynthesisUtterance(words.slice(index).join(" "));
...
/* ============================================================================
   8) BOTÓN PREMIUM FIJO — CFC STYLE
============================================================================ */
