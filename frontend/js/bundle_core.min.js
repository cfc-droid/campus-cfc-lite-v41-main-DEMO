(function(){function loadScript(e){return new Promise((t,r)=>{const n=document.createElement("script");n.src=e+"?v=20251116",n.defer=!0,n.onload=()=>t(e),n.onerror=()=>r(e),document.head.appendChild(n)})}
console.log("CFC-SYNC V72 — bundle_core.min.js iniciado (FIX 2025-11-18)");
...
// REMOVIDOS PARA EVITAR DUPLICACIÓN
...
(async()=>{for(const e of scripts)try{await loadScript(e),console.log("CFC-LOADER OK:",e)}catch(t){console.warn("CFC-LOADER ERROR:",t)}console.log("CFC-SYNC V72 — bundle_core.min.js completado (FIX aplicado)")})();
})();
