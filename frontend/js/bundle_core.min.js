...
console.log("CFC-SYNC V72 — bundle_core.min.js iniciado");
const scripts=[
...
(async()=>{for(const e of scripts)try{await loadScript(e),console.log("CFC-LOADER OK:",e)}catch(t){console.warn("CFC-LOADER ERROR:",t)}
console.log("CFC-SYNC V72 — bundle_core.min.js completado")})()})();
